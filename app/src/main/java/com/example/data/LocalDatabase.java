                    ...
                    public void onCreate(@NonNull SupportSQLiteDatabase db) {
                        ...
                        Executors.newSingleThreadExecutor().execute(() -> {
                            ...
                            tmp.robotModelDAO().insertAll(
                                    new RobotModel(0, "Kettenroboter", "EV3", "joystick:50;1,8", "Linken Kettenmotor an Port A anschließen und rechten Kettenmotor an Port D anschließen."),
                                    new RobotModel(0, "Kettenroboter mit Greifarm", "EV3", "joystick:50;1,8|slider:30;4", "Linken Kettenmotor an Port A anschließen, rechten Kettenmotor an Port D anschließen und Motor des Greifarms an Port B anschießen."),
                                    ...
                                    new RobotModel(0, "Gensearsch", "EV3", "button:20;1;5000|button:20;2;5000|button:20;4;5000|button:20;8;5000", "Richtig viel Zeug"),
                                    new RobotModel(0, "Greifarm", "EV3", "slider:30;4", "Motor des Greifarms wird an Port B angeschlossen."),
